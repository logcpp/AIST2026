...
routing_wg_pitch = 5
MZM_routing_height_max = 3500 + 10 + 12*routing_wg_pitch
MZM_routing_width_max = 1000 + 50 + 12*routing_wg_pitch
MZM_routing_width_ssc_min = 5000 - 200 - 12*routing_wg_pitch

# top right
def PINL200_01_route_cell(origin, end_o, end_point, layer, cell_name):
	ret_cell = gdstk.Cell(cell_name)
	# top right port
	o = [
		origin[0] + end_o[0] + 100,
		origin[1] + end_o[1],
	]
	o = vertical(o, 10, layer, ret_cell)
	o = arc_UR(o, layer, ret_cell)
	hl = MZM_routing_width_max - o[0]
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RD(o, layer, ret_cell)
	vl = MZM_routing_height_max - o[1]
	o = vertical(o, vl, layer, ret_cell)
	o = arc_DR(o, layer, ret_cell)
	hl = MZM_routing_width_ssc_min - o[0]
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RU(o, layer, ret_cell)
	vl = end_point[1] - (radius+dr) - o[1]
	o = vertical(o, vl, layer, ret_cell)
	o = arc_UR(o, layer, ret_cell)
	hl = end_point[0] - o[0]
	o = horizontal(o, hl, layer, ret_cell)
	...
	o = arc_DR(o, layer, ret_cell)
	hl = MZM_routing_width_max - o[0] - 1*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RD(o, layer, ret_cell)
	vl = MZM_routing_height_max - o[1] - 1*routing_wg_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_DR(o, layer, ret_cell)
	hl = MZM_routing_width_ssc_min - o[0] + 1*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RU(o, layer, ret_cell)
	vl = end_point[1] - (radius+dr) - o[1] - 1*ssc_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_UR(o, layer, ret_cell)
	hl = end_point[0] - o[0]
	o = horizontal(o, hl, layer, ret_cell)
	...
	o = vertical(o, -1 * routing_wg_pitch, layer, ret_cell)
	o = arc_DR(o, layer, ret_cell)
	hl = MZM_routing_width_max - o[0] - 2*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RD(o, layer, ret_cell)
	vl = MZM_routing_height_max - o[1] - 2*routing_wg_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_DR(o, layer, ret_cell)
	hl = MZM_routing_width_ssc_min - o[0] + 2*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RU(o, layer, ret_cell)
	vl = end_point[1] - (radius+dr) - o[1] - 2*ssc_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_UR(o, layer, ret_cell)
	hl = end_point[0] - o[0]
	o = horizontal(o, hl, layer, ret_cell)
...
# bot right
def PINL500_01_route_cell(origin, end_o, end_point, layer, cell_name):
	ret_cell = gdstk.Cell(cell_name)
	# top right port
	o = [
		origin[0] + end_o[0] + 100,
	...
	o = arc_UR(o, layer, ret_cell)
	hl = MZM_routing_width_max - o[0] - 3*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RD(o, layer, ret_cell)
	vl = MZM_routing_height_max - o[1] - 3*routing_wg_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_DR(o, layer, ret_cell)
	hl = MZM_routing_width_ssc_min - o[0] + 3*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RU(o, layer, ret_cell)
	vl = end_point[1] - (radius+dr) - o[1] - 3*ssc_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_UR(o, layer, ret_cell)
	hl = end_point[0] - o[0]
	o = horizontal(o, hl, layer, ret_cell)
	...
	o = arc_DR(o, layer, ret_cell)
	hl = MZM_routing_width_max - o[0] - 4*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RD(o, layer, ret_cell)
	vl = MZM_routing_height_max - o[1] - 4*routing_wg_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_DR(o, layer, ret_cell)
	hl = MZM_routing_width_ssc_min - o[0] + 4*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RU(o, layer, ret_cell)
	vl = end_point[1] - (radius+dr) - o[1] - 4*ssc_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_UR(o, layer, ret_cell)
	hl = end_point[0] - o[0]
	o = horizontal(o, hl, layer, ret_cell)
	...
	o = vertical(o, -1 * routing_wg_pitch, layer, ret_cell)
	o = arc_DR(o, layer, ret_cell)
	hl = MZM_routing_width_max - o[0] - 5*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RD(o, layer, ret_cell)
	vl = MZM_routing_height_max - o[1] - 5*routing_wg_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_DR(o, layer, ret_cell)
	hl = MZM_routing_width_ssc_min - o[0] + 5*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RU(o, layer, ret_cell)
	vl = end_point[1] - (radius+dr) - o[1] - 5*ssc_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_UR(o, layer, ret_cell)
	hl = end_point[0] - o[0]
	o = horizontal(o, hl, layer, ret_cell)
...
# top left
def PINL200_02_route_cell(origin, end_o, end_point, layer, cell_name):
	ret_cell = gdstk.Cell(cell_name)
	# top right port
	o = [
		origin[0] + end_o[0] + 100,
	...
	o = arc_UR(o, layer, ret_cell)
	hl = MZM_routing_width_max - 500 - o[0] - 6*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RD(o, layer, ret_cell)
	vl = MZM_routing_height_max - o[1] - 6*routing_wg_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_DR(o, layer, ret_cell)
	hl = MZM_routing_width_ssc_min - o[0] + 6*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RU(o, layer, ret_cell)
	vl = end_point[1] - (radius+dr) - o[1] - 6*ssc_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_UR(o, layer, ret_cell)
	hl = end_point[0] - o[0]
	o = horizontal(o, hl, layer, ret_cell)
	...
	o = arc_DR(o, layer, ret_cell)
	hl = MZM_routing_width_max - 500 - o[0] - 7*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RD(o, layer, ret_cell)
	vl = MZM_routing_height_max - o[1] - 7*routing_wg_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_DR(o, layer, ret_cell)
	hl = MZM_routing_width_ssc_min - o[0] + 7*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RU(o, layer, ret_cell)
	vl = end_point[1] - (radius+dr) - o[1] - 7*ssc_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_UR(o, layer, ret_cell)
	hl = end_point[0] - o[0]
	o = horizontal(o, hl, layer, ret_cell)
	...
	o = vertical(o, -1 * routing_wg_pitch, layer, ret_cell)
	o = arc_DR(o, layer, ret_cell)
	hl = MZM_routing_width_max - 500 - o[0] - 8*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RD(o, layer, ret_cell)
	vl = MZM_routing_height_max - o[1] - 8*routing_wg_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_DR(o, layer, ret_cell)
	hl = MZM_routing_width_ssc_min - o[0] + 8*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RU(o, layer, ret_cell)
	vl = end_point[1] - (radius+dr) - o[1] - 8*ssc_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_UR(o, layer, ret_cell)
	hl = end_point[0] - o[0]
	o = horizontal(o, hl, layer, ret_cell)
...
# bot left
def PINL500_02_route_cell(origin, end_o, end_point, layer, cell_name):
	ret_cell = gdstk.Cell(cell_name)
	# top right port
	o = [
		origin[0] + end_o[0] + 100,
	...
	o = arc_UR(o, layer, ret_cell)
	hl = MZM_routing_width_max - 500 - o[0] - 9*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RD(o, layer, ret_cell)
	vl = MZM_routing_height_max - o[1] - 9*routing_wg_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_DR(o, layer, ret_cell)
	hl = MZM_routing_width_ssc_min - o[0] + 9*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RU(o, layer, ret_cell)
	vl = end_point[1] - (radius+dr) - o[1] - 9*ssc_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_UR(o, layer, ret_cell)
	hl = end_point[0] - o[0]
	o = horizontal(o, hl, layer, ret_cell)
	...
	o = arc_DR(o, layer, ret_cell)
	hl = MZM_routing_width_max - 500 - o[0] - 10*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RD(o, layer, ret_cell)
	vl = MZM_routing_height_max - o[1] - 10*routing_wg_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_DR(o, layer, ret_cell)
	hl = MZM_routing_width_ssc_min - o[0] + 10*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RU(o, layer, ret_cell)
	vl = end_point[1] - (radius+dr) - o[1] - 10*ssc_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_UR(o, layer, ret_cell)
	hl = end_point[0] - o[0]
	o = horizontal(o, hl, layer, ret_cell)
	...
	o = vertical(o, -1 * routing_wg_pitch, layer, ret_cell)
	o = arc_DR(o, layer, ret_cell)
	hl = MZM_routing_width_max - 500 - o[0] - 11*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RD(o, layer, ret_cell)
	vl = MZM_routing_height_max - o[1] - 11*routing_wg_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_DR(o, layer, ret_cell)
	hl = MZM_routing_width_ssc_min - o[0] + 11*routing_wg_pitch
	o = horizontal(o, hl, layer, ret_cell)
	o = arc_RU(o, layer, ret_cell)
	vl = end_point[1] - (radius+dr) - o[1] - 11*ssc_pitch
	o = vertical(o, vl, layer, ret_cell)
	o = arc_UR(o, layer, ret_cell)
	hl = end_point[0] - o[0]
	o = horizontal(o, hl, layer, ret_cell)
